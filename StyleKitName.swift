...
//  SaveTheBird
//
//  Created by Daniel Peters on 20.12.15.
...
public class StyleKitName : NSObject {
    ...
    public class func drawSun(frame frame: CGRect = CGRectMake(0, 0, 128, 128)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()


        //// Shadow Declarations
        let shadow = NSShadow(color: StyleKitName.sunYellow, offset: CGSizeMake(0.1, -0.1), blurRadius: 11)

        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalInRect: CGRectMake(frame.minX + floor(frame.width * 0.09375 + 0.5), frame.minY + floor(frame.height * 0.08594 + 0.5), floor(frame.width * 0.91406 + 0.5) - floor(frame.width * 0.09375 + 0.5), floor(frame.height * 0.90625 + 0.5) - floor(frame.height * 0.08594 + 0.5)))
        CGContextSaveGState(context)
        ...
        CGContextBeginTransparencyLayer(context, nil)
        let ovalOpaqueShadow = (shadow.shadowColor as! UIColor).colorWithAlphaComponent(1)
    ...
    public class func imageOfSun(frame frame: CGRect = CGRectMake(0, 0, 128, 128)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(frame.size, false, 0)
            StyleKitName.drawSun(frame: CGRectMake(0, 0, frame.size.width, frame.size.height))
